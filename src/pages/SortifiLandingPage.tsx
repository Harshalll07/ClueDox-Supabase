  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      (function () {
        ...
        ═══════════════════════════════════════════ */
        function drive(p) {
          const cardSlideStart = 0.72;
          const cardSlideEnd = 0.9;
          ...
          WCARDS.forEach((c, i) => {
            ...
            if (i === 0 && pr(p, cardSlideStart, cardSlideEnd) > 0) return;
          ...
          const slideP = eo(pr(p, cardSlideStart, cardSlideEnd));
          updateWires(slideP);
          ...
          /* 5. Typing */
          const typP = pr(p, 0.62, cardSlideStart);
          if (typP > 0 && typP < 1) {
          ...
          */
          if (slideP > 0) {
            ...
            const desiredEndTop = (sbRect.bottom - srRect.top) + 32;
            const estimatedExpandedCardHeight = window.innerWidth < 1200 ? 500 : 430;
            const maxVisibleTop = Math.max(96, window.innerHeight - estimatedExpandedCardHeight - 24);
            const endTop = Math.min(desiredEndTop, maxVisibleTop);
